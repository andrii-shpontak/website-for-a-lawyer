...
const rejectVLK = require('../../../../../../assets/documents/заява оскарження рішення ВЛК.pdf');
const vocationReport = require('../../../../../../assets/documents/Рапорт_на_відпустку_за_станом_здоров’я_на_підставі_довідки_ВЛК.docx');
const socPobReport = require('../../../../../../assets/documents/Рапорт_на_отримання_матеріальної_допомоги_для_вирішення_соціально.docx');
const heathyReport = require('../../../../../../assets/documents/рапорт_на_виплату_на_оздоровлення.docx');
...
export const tabs = [
  {
    ...
    docs: [
      {
        docName: 'рапорт_на_ВЛК.docx',
        docTitle: 'Рапорт на проходження ВЛК',
        docLink: medReport,
      },
      {
        docName: 'рапорт_на_ВЛК_на_і`мя_командира.docx',
        docTitle: 'Рапортна на і`мя командира видати направлення на ВЛК ',
        docLink: commandName,
      },
    ],
  },
  {
    ...
    docs: [
      {
        docName: 'Рапорт на оскарження рішення ВЛК.pdf',
        docTitle: 'Рапорт на оскарження рішення ВЛК',
        docLink: rejectVLK,
      },
      {
        docName: 'Рапорт_на_відпустку_за_станом_здоров’я_на_підставі_довідки_ВЛК.docx',
        docTitle: 'Рапорт на відпустку за станом здоров’я на підставі довідки ВЛК',
        docLink: vocationReport,
      },
    ],
  },
  {
